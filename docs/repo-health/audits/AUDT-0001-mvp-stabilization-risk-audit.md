...
2. Continue with `IMPL-0001-02` for the verification gate, then `IMPL-0001-03` for characterization coverage across `FINDING-002`, `FINDING-009`, `FINDING-010`, and the highest-risk frontend behavior from `FINDING-011`.
...
- Execute `IMPL-0001-02` and `IMPL-0001-03` before code splitting.
